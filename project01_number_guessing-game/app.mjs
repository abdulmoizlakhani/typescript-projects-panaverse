...
function welcome() {
    ...
    figlet(msg, (err, data) => {
        ...
        rainbowTitle = chalkAnimation.rainbow("Welcome to Guess The Number! (A CLI based game developed by amlakhani)");
    });
}
async function howToGuide() {
    ...
    ${chalk.white("2. We will generate a new number between 0 to 10 in each round")}
...
async function generateRandomNumberAndAskUser(rounds) {
